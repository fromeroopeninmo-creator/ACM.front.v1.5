// frontend/app/dashboard/soporte/[empresaId]/page.tsx
...
export default async function SoporteEmpresaDetallePage({ params }: PageProps) {
  // 1) Guard: sesión + rol
      ...
      <header className="flex items-center justify-between">
        <div className="space-y-1">
          ...
          <p className="text-sm text-gray-500">
            Vista de solo lectura (MVP). Luego sumamos acciones auditadas.
          </p>
        </div>
        <a
