...
export default function LandingPage() {
  return <PublicShell>
    ...
    <section className="border-y border-white/10 bg-neutral-950 px-5 py-20 sm:px-8 lg:px-14">
      <div className="mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-[1.05fr_.95fr]">
        <div>
          <p className="text-sm font-semibold uppercase tracking-[.2em] text-[#E6A930]">Conocé el resultado</p>
          <h2 className="mt-4 text-3xl font-semibold sm:text-5xl">Mirá cómo se presentan los análisis a tus clientes.</h2>
          <p className="mt-5 max-w-2xl text-lg leading-8 text-neutral-300">Descargá ejemplos reales de los informes que podés generar con VAI Prop y conocé el nivel de presentación antes de comenzar.</p>
        </div>
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
          <a href="/landing/docs/ejemplo_Informe_VAI.pdf" target="_blank" rel="noreferrer" className="group rounded-3xl border border-white/10 bg-white/[.04] p-6 transition hover:border-[#E6A930]/55 hover:bg-white/[.06]">
            <span className="text-xs font-semibold uppercase tracking-[.18em] text-[#E6A930]">Valuación</span>
            <h3 className="mt-2 text-xl font-semibold">Informe VAI de ejemplo</h3>
            <p className="mt-3 text-sm leading-6 text-neutral-400">Conocé la estructura, presentación y nivel de detalle de una valuación profesional.</p>
            <span className="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-[#f2c76d]">Ver PDF <PublicIcon name="arrow" className="h-4 w-4 transition group-hover:translate-x-1"/></span>
          </a>
          <a href="/landing/docs/ejemplo_Informe_Factibilidad.pdf" target="_blank" rel="noreferrer" className="group rounded-3xl border border-white/10 bg-white/[.04] p-6 transition hover:border-[#E6A930]/55 hover:bg-white/[.06]">
            <span className="text-xs font-semibold uppercase tracking-[.18em] text-[#E6A930]">Factibilidad</span>
            <h3 className="mt-2 text-xl font-semibold">Informe de factibilidad</h3>
            <p className="mt-3 text-sm leading-6 text-neutral-400">Visualizá cómo se organiza el análisis preliminar del potencial de un terreno.</p>
            <span className="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-[#f2c76d]">Ver PDF <PublicIcon name="arrow" className="h-4 w-4 transition group-hover:translate-x-1"/></span>
          </a>
        </div>
      </div>
