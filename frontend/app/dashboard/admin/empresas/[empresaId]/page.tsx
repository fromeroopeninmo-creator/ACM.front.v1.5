// app/dashboard/admin/empresas/[empresaId]/page.tsx
...
export default async function AdminEmpresaDetallePage({ params }: PageProps) {
  ...
  // Fetch SSR del detalle (reutilizamos el endpoint de soporte que permite admin)
  ...
  const correoResetDefault = ""; // admin puede cargarlo manualmente
    ...
    <main className="p-4 md:p-6 space-y-4">
      ...
      {errorMsg ? (
        ...
        <>
          ...
          {/* Acciones (reutilizamos componente de Soporte por ahora) */}
          <section className="rounded-2xl border p-4 bg-white dark:bg-neutral-900">
            <AccionesSoporte
