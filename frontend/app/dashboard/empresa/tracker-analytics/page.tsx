      ...
      try {
        ...
        const [contactosRes, propiedadesRes, tercerosRes, actividadesRes, asesoresRes] = await Promise.all([
          ...
          supabase
            ...
            .eq("empresa_id", empresaId),
          supabase.from("asesores").select("id, nombre, apellido").eq("empresa_id", empresaId),
        ]);

        if (contactosRes.error || propiedadesRes.error || tercerosRes.error || actividadesRes.error || asesoresRes.error) {
        ...
        <div className="max-w-3xl mx-auto px-4 py-10">
          <div className="rounded-2xl border border-amber-200 bg-amber-50 px-4 py-6">
            ...
            <p className="mt-2 text-sm text-slate-600">
              El módulo de <span className="font-semibold">Business Analytics</span> está disponible únicamente para usuarios empresa. Si necesitás acceder, consultá con el administrador de tu cuenta.
            </p>
          </div>
        </div>
      </div>
        ...
        <header className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-600 max-w-xl">
              Centralizá la información de tu empresa y tus asesores: ventas, alquileres, actividad comercial, honorarios, administración y conversión.
            </p>
          </div>
          ...
          <div className="rounded-2xl bg-white border border-gray-200 shadow-sm p-4">
            <div className="flex items-center justify-between mb-3">
              <div>
                ...
                <p className="text-[11px] text-slate-500">
                  Ajustá el reparto neto entre empresa y asesores para simular el impacto económico.
                </p>
              </div>
              ...
              <div className="flex flex-col items-end justify-around h-48 gap-4">
                <div className="flex justify-around w-full gap-4 items-end">
                  ...
                  <div className="flex flex-col items-center gap-1">
                    ...
                    />
                    <span className="text-[11px] text-slate-700 text-center">Asesores ({asesorPct.toFixed(0)}%)</span>
