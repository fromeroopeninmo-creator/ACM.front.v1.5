...
export default function Header() {
  ...
  // El botón solo se muestra dentro del valuador ACM.
  const estaEnValuador =
    pathname === "/vai/acmforms" ||
    pathname?.startsWith("/vai/acmforms/");
    ...
    >
      ...
      <div className="flex w-full items-center justify-between md:hidden">
        ...
        <div className="flex flex-col text-[11px] sm:text-sm font-semibold text-white leading-tight text-left">
          ...
          {/* Botón volver: solo dentro del valuador */}
          {estaEnValuador ? (
      ...
      <div className="hidden md:flex w-full justify-between items-center relative">
        {/* Izquierda: botón volver solo dentro del valuador */}
