        ...
        >
          <div className="mx-auto max-w-6xl px-4 py-10 md:py-16">
            <div className="grid gap-10 md:gap-12 md:grid-cols-[1fr_1fr] md:items-center">
              ...
              <div className="w-full md:w-[96%] lg:w-[94%] mx-auto rounded-3xl border border-neutral-800 bg-gradient-to-br from-neutral-900 to-black p-3 md:p-4 shadow-[0_25px_60px_rgba(0,0,0,0.85)]">
  <div className="relative overflow-hidden rounded-[1.4rem] bg-black">
    <div className="relative w-full h-[190px] sm:h-[220px] md:h-[250px] lg:h-[280px]">
