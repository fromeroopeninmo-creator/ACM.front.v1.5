  ...
  return (
    <main className="p-4 md:p-6 space-y-6">
      <header className="space-y-1">
        <h1 className="text-xl md:text-2xl font-semibold">Configuración (Admin)</h1>
        <p className="text-sm text-gray-500">
          Ajustes de tu cuenta de administrador. Próximamente: Perfil, Seguridad, Avatar y Preferencias.
        </p>
      </header>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="rounded-2xl border p-4 bg-white dark:bg-neutral-900">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">
            Cambio de email / contraseña y resets (incluye super_admin_root). 
          </p>
